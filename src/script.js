...
function glMain ()
{
    ...
    function render ()
    {
        ...
        textData.texts.forEach((textItem, index) =>
        {
            ...
            let arrowVertices;
            if(lastFiveIterations[lastFiveIterations.length-2] > combinedValue) {
                arrowVertices = new Float32Array([
                    100, -5, 
                    100, 15, 
                    95, 8, 
                    100, 15, 
    ...
    function renderImage ()
    {
        ...
        const imgVertices = new Float32Array([
            -0.28, -0.15, 0.0, 0.0, // Нижній лівий кут
            -0.24, -0.15, 1.0, 0.0, // Нижній правий кут
            -0.24, -0.08, 1.0, 1.0, // Верхній правий кут
            -0.28, -0.08,  0.0, 1.0, // Верхній лівий кут
        ]);
